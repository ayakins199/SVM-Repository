...
namespace SVM
{
    ...
    public class RangeTransform : IRangeTransform
    {
        ...
        /// <summary>
        /// Transform the input value using the formula: x' = (x - Mina)/(Maxa - Mina). x' is the scaled value, Mina and Maxa are..
        /// ..the minimum and maximum values of feature a, and x is the original value to be transformed
        /// </summary>
        /// <param name="input">Input value</param>
        /// <param name="i">Index of the row</param>
        /// /// <param name="j">Index of the column</param>
        /// <returns>The transformed value</returns>
        public double Transform(double[,] input, int i, int j)
        {
            //index--;
            double scaledVal = input[i, j];
            //if (_stddevs[index] == 0)
            //    return 0;
