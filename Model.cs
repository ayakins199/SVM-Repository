...
namespace SVM
{
	...
	public class Model
	{
        ...
        private double[] _supportVectorsClassLabels;
        internal Model()
        {
        }
        ...
        /// <summary>
        /// Set the class labels for Support Vectors
        /// </summary>
        public double[] SupportVectorsClassLabels
        {
            get
            {
                return _supportVectorsClassLabels;
            }
            set
            {
                _supportVectorsClassLabels = value;
            }
        }
