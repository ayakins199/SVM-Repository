...
namespace SVM
{
    ...
    public static class Prediction
    {
            ...
            bool predict_probability)
        {
            ...
            //StreamWriter output = outputFile != null ? new StreamWriter(outputFile,true) : null;
            ...
            for (int i = 0; i < problem.Count; i++)
            {
                ...
                //File.AppendAllText(outpuVectorFilePath, v.ToString());
                //File.AppendAllText(outpuVectorFilePath, " ");
            ...
            //File.AppendAllText(outpuVectorFilePath, Environment.NewLine);
